	...
	return (
		<header className="medium-blue-bg py-6 px-12 light-c text-sm">
			<nav className="lg:flex items-center">
				...
				<button
					className={`lg:hidden float-right align-bottom ${
						showHamburger ? "" : "hidden"
					}`}
					onClick={toggle}
				>
				...
				<ul className={`${showHamburger ? "hidden" : ""}`}>
					<li
						className={`mt-4 ${
							router.pathname == "/booking" ? "opacity-50" : ""
						}`}
					>
					...
					<li
						className={`mt-4 ${
							router.pathname == "/about" ? "opacity-50" : ""
						}`}
					>
					...
					<li
						className={`mt-4 ${
							router.pathname == "/register" ? "opacity-50" : ""
						}`}
					>
					...
					<li
						className={`mt-4 ${
							router.pathname == "/login" ? "opacity-50" : ""
						}`}
					>
